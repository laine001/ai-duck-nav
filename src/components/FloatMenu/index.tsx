  ...
  return (
    <div className="fixed bottom-10 right-4 z-50">
      <div className="dropdown dropdown-hover dropdown-top dropdown-end">
        ...
        <ul
          tabIndex={0}
          className="dropdown-content menu bg-base-100 rounded-box z-1 shadow-sm p-2 gap-2"
        >
          <li>
            <button onClick={scrollToTop} className="btn btn-circle btn-ghost">
