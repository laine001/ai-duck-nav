...
export const categoryList = [
  {
    ...
    bgColor: "bg-blue-100",
    icon: (
      <FontAwesomeIcon className={"text-primary text-xl"} icon={faComment} />
    ),
  },
  {
    categoryName: "AI搜索",
  ...
  },
  {
    ...
    icon: (
      <FontAwesomeIcon className={"text-yellow-600 text-xl"} icon={faImage} />
    ),
  },
  {
    categoryName: "AI编程",
    ...
    icon: (
      <FontAwesomeIcon className={"text-orange-600 text-xl"} icon={faCode} />
    ),
  },
  {
    categoryName: "AI音频",
  ...
  },
  {
    ...
    icon: (
      <FontAwesomeIcon className={"text-amber-600 text-xl"} icon={faVideo} />
    ),
  },
  {
    categoryName: "办公工具",
